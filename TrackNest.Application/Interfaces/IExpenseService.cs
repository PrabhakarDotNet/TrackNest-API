...
namespace TrackNest.Application.Interfaces
{
    ...
    {
        Task<PagedResult<ExpenseDto>> GetByUserIdAsync(int userId, int page = 1, int pageSize = 10, string sortBy = "expenseDate", string sortDirection = "desc", string? searchTerm = null, CancellationToken ct = default);
